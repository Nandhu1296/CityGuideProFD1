...
class firstScreenVC: UIViewController, UIPickerViewDelegate, UIPickerViewDataSource {
    ...
    let words = ["Difficulty Seeing" , "General User" , "Difficulty Moving"]
    ...
    var chosenWordIndex: Int = 0
      ...
      func pickerView(_ pickerView: UIPickerView, didSelectRow row: Int, inComponent component: Int) {
          ...
          }else if(chosenWord=="Difficulty Moving"){
              chosenWordIndex = 2
              chosenWord = "Difficulty Moving"
...
//        userDefaults.set(phoneNumberValue, forKey: "myContactUserNumberKey3")
        showToast(message: "Saved Successfully as  ", seconds: 1.0)
