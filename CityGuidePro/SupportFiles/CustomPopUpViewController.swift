...
final class CustomPopUpViewController: UIViewController {
    ...
    private func scenario() {
        ...
        case .call911:
            descriptionLabel.text = "Are you sure you want to 911?"
        case .sendLocation:
            descriptionLabel.text = "Are you sure you want to share your location with your emergency contact?"
        default:
            break
        }
    }
